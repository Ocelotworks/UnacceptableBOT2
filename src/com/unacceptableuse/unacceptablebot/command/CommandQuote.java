...
public class CommandQuote extends Command
{
	...
	public void performCommand(User sender, Channel channel, String message, String[] args)
	{
		...
		try
		{
			...
			{
				PreparedStatement ps = UnacceptableBot.getConfigHandler().sql.getPreparedStatement("SELECT Message FROM `teknogeek_unacceptablebot`.`" + quoteChannel + "` WHERE Username = '" + args[1] // No replace needed
